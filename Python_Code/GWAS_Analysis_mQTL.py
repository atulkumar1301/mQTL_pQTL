...
subprocess.run ([plink2, "--pfile", base_file, "--keep", "Keep_Patients.txt", "--maf", "0.05", "--glm" ,"cols=+a1freq", "hide-covar", "--pheno", "Pheno.txt", "--covar", "Covariates.txt", "--covar-variance-standardize", "--ci", "0.95", "--pfilter", "1", "--out", out_file], cwd = pwd)
