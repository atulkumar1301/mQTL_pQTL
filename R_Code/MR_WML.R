...
for (metabolites in Exposure_List) {
  ...
  outcome_dat_AD=read_outcome_data (
    filename = "~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Tools/GWAS_Summary_Statistics/WML/WML_GWAS_GB38.txt",
    snps = sub$SNP,
    sep = "\t",
    snp_col = "SNP",
    beta_col = "Effect",
...
write.table (edf_All, file = paste0 ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/mQTL_pQTL/Metabolomics/MR_Study/MR_Results_WML_All.txt"), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)

write.table (edf_single, file = paste0 ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/mQTL_pQTL/Metabolomics/MR_Study/MR_Results_WML_Single.txt"), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)

write.table (het_stat, file = paste0 ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/mQTL_pQTL/Metabolomics/MR_Study/MR_Results_Heterogeneity_WML.txt"), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)

write.table (hor_plei_stat, file = paste0 ("~/Library/CloudStorage/OneDrive-UniversityofEasternFinland/Work/Projects/mQTL_pQTL/Metabolomics/MR_Study/MR_Results_pleiotropy_WML.txt"), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
