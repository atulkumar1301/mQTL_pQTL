...
df <- fread ("/Volumes/Macintosh HD/Users/akumar/OneDrive - University of Eastern Finland/Work/Projects/mQTL_pQTL/Metabolomics/MR_Study/mQTL_Results_No_Pleiotropy_e-11.txt")
...
for (metabolites in Exposure_List) {
  ...
  outcome_dat_AD=read_outcome_data (
    filename = "/Volumes/Macintosh HD/Users/akumar/OneDrive - University of Eastern Finland/Tools/GWAS_Summary_Statistics/Summary_Data_AD_A_beta.txt",
    snps = sub$SNP,
    sep = "\t",
    snp_col = "SNP",
    beta_col = "BETA",
...
write.table (edf_All, file = paste0 ("/Volumes/Macintosh HD/Users/akumar/OneDrive - University of Eastern Finland/Work/Projects/mQTL_pQTL/Metabolomics/MR_Study/MR_Results_Abeta_All.txt"), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)

write.table (edf_single, file = paste0 ("/Volumes/Macintosh HD/Users/akumar/OneDrive - University of Eastern Finland/Work/Projects/mQTL_pQTL/Metabolomics/MR_Study/MR_Results_Abeta_Single.txt"), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
